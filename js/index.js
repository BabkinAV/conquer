...
function show_hide() {
    var click = document.getElementById("drop-menu");
    click.classList.toggle('showElem');
}
...
scrollID = document.getElementById("scrollup");

var myScrollFunc = function() {
  var y = window.scrollY;
  if (y >= 500) {
    scrollID.className = "scrollup scrollup--show";
    scrollID.addEventListener('click', function() {
        smoothScroll('#target-01', 1000);
    });
    
  } else {
    scrollID.className = "scrollup scrollup--hide";
    scrollID.removeEventListener('click', function() {
        smoothScroll('#target-01', 1000);
    });
  }
};
